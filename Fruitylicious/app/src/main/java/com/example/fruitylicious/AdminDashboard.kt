        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                Column(
                    ...
                    DashboardTile(
                        title = "Manage\nProducts",
                        backgroundColor = Color(0xFFFFB300), // Yellow-Orange
                        height = 110.dp,
                        bgEmoji = "📦",
                        onClick = { /* TODO */ }
                    )
                    ...
                    DashboardTile(
                        title = "Recipe\nManagement",
                        backgroundColor = Color(0xFF68C971), // Green
                        height = 150.dp,
                        bgEmoji = "📖",
                        onClick = { /* TODO */ }
                    )
                ...
                Column(
                    ...
                    DashboardTile(
                        title = "Inventory\nMonitoring",
                        backgroundColor = Color(0xFFF27979), // Red/Pink
                        height = 125.dp,
                        bgEmoji = "🔍",
                        onClick = { /* TODO */ }
                    )
...
fun AdminHeader(onMenuClick: () -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .background(Color(0xFF2C8C44)) // Deeper forest green
...
fun StartSellingCardAdmin(navController: NavController) {
    Surface(
        ...
        color = Color(0xFFFAFF82), // Bright yellow
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            Text(
                ...
                modifier = Modifier
                    ...
                    .alpha(0.15f) // Makes it look like a subtle background watermark
            )
