...
fun WasteEntryScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            FruitySectionTitle(
                title = "Log Waste",
                subtitle = "Waste deducts inventory immediately"
            )
            ...
            ExposedDropdownMenuBox(
                ...
                OutlinedTextField(
                    ...
                    modifier = Modifier.menuAnchor().padding(bottom = 2.dp),
            ...
            if (uiState.image.isNotBlank()) {
                AsyncImage(
                    model = uiState.image,
                    contentDescription = "Waste proof image preview"
                )
            }
