...
@Composable
fun AdminAdjustmentScreen(
    onBack: () -> Unit,
    viewModel: AdminAdjustmentViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            FruitySectionTitle(
                ...
                subtitle = "Positive values add stock; negative values deduct stock"
            )
