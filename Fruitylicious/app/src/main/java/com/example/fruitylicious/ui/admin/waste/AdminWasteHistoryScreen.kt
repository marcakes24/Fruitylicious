...
import com.example.fruitylicious.ADMIN_WASTE_ENTRY
...
fun AdminWasteHistoryScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Admin Waste History") },
                navigationIcon = {
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                onClick = { onNavigate(ADMIN_WASTE_ENTRY) },
    ...
    Card(
        ...
        Column(
            ...
            if (!log.image.isNullOrBlank()) {
                AsyncImage(
                    model = log.image,
                    contentDescription = "Waste proof",
                    modifier = Modifier.fillMaxWidth()
                )
            }
            ...
            Text(
                text = "Quantity: ${log.quantity} $unit",
